...
export default function FriendsScreen({ navigation }) {
    ...
    let currency = "₹"
    let friends = [
        { name: "Josh Hazlewood", owesYou: true, amount: 500 },
        { name: "Rajat Patidar", owesYou: false, amount: 400 },
        { name: "Jitesh Sharma", owesYou: true, amount: 100 },
        { name: "Swapnil Singh", owesYou: true, amount: 0 }
    ]
